      ...
      <div className="relative z-10 flex max-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="mt-10 w-[800px] m-auto bg-white/30 backdrop-blur-3xl rounded-lg p-8 shadow-2xl">
          <div className="mx-auto w-[600px]">
            <h1 className="lg:text-3xl md:text-2xl text-xl font-serif font-semibold mb-2 text-[#424874]">Profile</h1>
            ...
            <form>
              ...
              <h2 className="text-center mt-3 font-semibold  text-[#424874]">Upload Profile and Cover Image</h2>
              <div className="flex flex-col lg:flex-row gap-2 justify-center w-full">
                <div className="w-full mb-4 mt-6">
                  <label htmlFor="firstName" className="mb-2 text-[#424874]">First Name</label>
                  <input type="text" id="firstName" className="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800 backdrop-blur-sm  placeholder-[#f4eeff] " placeholder="First Name" />
                </div>
                <div className="w-full mb-4 lg:mt-6">
                  <label htmlFor="lastName" className="text-[#424874]">Last Name</label>
                  <input type="text" id="lastName" className="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800 backdrop-blur-sm placeholder-[#f4eeff]" placeholder="Last Name" />
                </div>
              </div>
              ...
              <div className="flex flex-col lg:flex-row gap-2 justify-center w-full">
                <div className="w-full">
                  ...
                  <select id="sex" className="w-full text-grey border-2 rounded-lg p-4 pl-2 pr-2 dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800 backdrop-blur-sm">
                ...
                <div className="w-full">
                  ...
                  <input type="date" id="dob" className="text-grey p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800 backdrop-blur-sm" />
                </div>
              </div>

              <div className="w-full rounded-lg bg-[#424874] mt-4 text-white text-lg font-semibold">
                <button type="submit" className="w-full p-4 text-[ #f4eeff]">Submit</button>
              </div>
            </form>
          </div>
        </div>
