...
import com.elearning.dtos.EnrollmentRequestDTO;
...
public class EnrollmentController {
    ...
    @PostMapping("/enroll")
    public String enrollStudent(@RequestBody EnrollmentRequestDTO request) {
        return enrollService.enrollStudent(request.getCourseId(), request.getStudentId());
    }
