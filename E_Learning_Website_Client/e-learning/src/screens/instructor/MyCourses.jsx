                ...
                <tbody>
                  {courses.map((course) => (
                    <tr key={course.id} className="text-center border border-[#a6b1e1]">
                      ...
                      <td className={`border border-[#a6b1e1] p-2 ${course.status === "Completed" ? "text-green-600" : "text-blue-600"}`}>{course.status}</td>
                      <td className="border border-[#a6b1e1] p-2">{course.updatedAt}</td>
                      <td className="border border-[#a6b1e1] p-2 flex justify-center gap-2">
                        {/* See Modules */}
                        <Tooltip content="See Modules">
                          <Link to={`/instructor/courses/${course.id}/modules`} className="cursor-pointer">
                        ...
                        <Tooltip content="Delete Module">
                          <IconButton
                            ...
                            onClick={() => console.log(`Delete module for course ${course.id}`)}
                          >
