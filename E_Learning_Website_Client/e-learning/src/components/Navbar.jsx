                    ...
                    <div className="md:flex md:items-center md:gap-12 z-10">
                        <nav aria-label="Global" className="hidden md:block">
                            <ul className="flex items-center gap-6 text-sm">
                                ...
                                <li className="relative">
                                    <a href="/mylearning" className="text-white cursor-pointer transition-all duration-200 hover:bg-[#f4eeff] hover:text-[#424874] px-2 py-1 rounded-md" href="/mylearning">
                                        My Learning
                                    </a>
                                </li>
