...
import Quiz from './screens/student/Quiz.jsx';
import CourseModules from './screens/instructor/Coursemodules.jsx';
import Profile from './screens/globals/Profile.jsx';
import Setquiz from './screens/instructor/Setquiz.jsx';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/instructor/courses/:courseId/modules/:moduleId/setquiz" Component={Setquiz} />
